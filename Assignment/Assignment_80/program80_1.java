...
class program80_1
{
    public static void main(String A[])
    {
        ...
        System.out.println("Enter electricty consumption of each city : ");
        ...
        for(i = 0 ; i < N ; i++)
        {
            ...
            for(j = 0 ; j < 7 ; j++)
            {
                ...
                if(no < 0)              // Concumption should not be negative
                {
                    System.out.println("Invalid input");
                    return;
                }
        ...
        for(Day = 0 ; Day < 7 ; Day++)          // Column wise :  change i and j loop
        {
            DaySum = 0;
