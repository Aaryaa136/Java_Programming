...
//////////////////////////////////////////////////////////
//
//Description:      Accepts file name , and integer N from user and copy last byte into a new file
//Input:            File , File , N
//Output:           Nothing
...
class program62_3
{
    public static void main(String A[]) throws Exception
    {
        ...
        if(fobj.exists() && fobj.isFile())
        {
            ...
            System.out.println("Last "+ n + " bytes copied sucessfully");
        }
        else
        {
